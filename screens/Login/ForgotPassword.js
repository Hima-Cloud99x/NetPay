...
const ForgotPassword = () => {
  ...
  return (
    <View style={styles.window}>
      ...
      <Text style={styles.textStyle1}>Forgot Password</Text>
      <Text style={styles.textStyle2}>
        Select verification method and we will send
      </Text>
      <Text style={styles.textStyle5}>you verification code</Text>
      <TouchableOpacity
        style={option === 1 ? styles.selectedCard : styles.card}
        onPress={() => {
          setOption(1);
          navigation.navigate('VerifyCode'); // Navigate to the VerifyEmail screen
        }}
      >
        <Image source={email} />
        <View>
      ...
      <TouchableOpacity
        ...
        onPress={() => {
          setOption(2);
          navigation.navigate('PhoneNo'); // Navigate to the PhoneNo screen
        }}
      >
        <Image source={phone} />
        <View>
